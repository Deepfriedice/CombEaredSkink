...
namespace MyBotTests
{
    ...
    public class EvaluateTests
    {
        ...
        public void RecursiveBoardScore_OnPositions(int depth, int expected, string position)
        {
            var bot = new MyBot();
            Board board = Board.CreateBoardFromFEN(position);
            int score = bot.RecursiveBoardScore(board, depth, int.MinValue, int.MaxValue);
        ...
        public void RecursiveBoardScore_CountEvaluations(int depth, int expected, string position)
        {
            var bot = new MyBot();
            Board board = Board.CreateBoardFromFEN(position);
            bot.RecursiveBoardScore(board, depth, int.MinValue, int.MaxValue);
